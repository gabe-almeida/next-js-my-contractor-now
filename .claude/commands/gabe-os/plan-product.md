...
This process will create these files in `@gabe-os/product/` directory.
...
- Create `@gabe-os/product/mission.md` with product vision and strategy
- Create `@gabe-os/product/roadmap.md` with phased development plan
- Create `@gabe-os/product/tech-stack.md` documenting all of this product's tech stack choices
...
✅ Product mission: `@gabe-os/product/mission.md`
✅ Product roadmap: `@gabe-os/product/roadmap.md`
✅ Product tech stack: `@gabe-os/product/tech-stack.md`

NEXT STEP 👉 Run `/new-spec` to start work on a feature!
```
