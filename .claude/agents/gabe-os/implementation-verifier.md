...
2. **Update roadmap (if applicable)**: Check `gabe-os/product/roadmap.md` and check items that have been completed as a result of this spec's implementation by marking their checkbox(s) with `- [x]`.
