        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              // Allow connections to TrustedForm, Jornaya/LeadID, Radar, and Meta/Facebook (Conversion API)
              "connect-src 'self' https://*.radar.io https://*.radar.com https://radar-verify.com https://*.trustedform.com https://*.lidstatic.com https://*.leadid.com https://*.facebook.net https://graph.facebook.com" + (process.env.NODE_ENV === 'development' ? " wss://localhost:* ws://localhost:*" : ""),
