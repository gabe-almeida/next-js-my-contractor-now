 ...
 */
export const DEFAULT_TCPA_TEXT = `By submitting, you authorize My Contractor Now and up to four <a href="/home-improvement-companies" class="text-orange-600 hover:text-orange-700 underline">Home Improvement Companies</a> to contact you at the number and email provided — including via automated calls, prerecorded voice, and SMS/MMS — regarding your inquiry, even if your number is on the National Do Not Call Registry or any state registry. Consent is not a condition of purchase and may be revoked at any time. Message and data rates may apply; frequency varies. By submitting, you agree to our <a href="/privacy-policy" class="text-orange-600 hover:text-orange-700 underline">Privacy Policy</a> and <a href="/terms-and-conditions" class="text-orange-600 hover:text-orange-700 underline">Terms and Conditions</a>.`;
